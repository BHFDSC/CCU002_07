...
# MAGIC %md # CCU002_07-D11a-outcomes
# MAGIC
...
#assert proj_child_inf_end_date == '2022-10-31'
...
# save name
outName = f'{proj}_out_inf_outcomes'.lower()
...
for i, table in enumerate(list_tables):
  print(i, table)
  outName = f'{proj}_out_inf_codelist_match{table}'.lower()
  tmp1 = globals()[table]
