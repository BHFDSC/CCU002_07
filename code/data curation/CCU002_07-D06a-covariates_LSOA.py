...
# tmp1 = spark.table(f'{dbc}.gdppr_{db}_archive')
# tmpt = tab(tmp1, 'archived_on')
...
tmp6 = temp_save(df=tmp6, out_name=f'{proj}_tmp_lsoa_tmp7'); print()
...
# save name
outName = f'{proj}_out_inf_covariates_lsoa'.lower()
