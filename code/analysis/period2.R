...
setwd("/db-mnt/databricks/rstudio_collab/CCU002_07/infection/riskratio_wen")
dataset = readRDS('cox_infec_ecds_050725_rmhistVaxInf.rds')
start_date = as.IDate("2021-06-01")
...
hr_table = fread(paste0('~/collab/CCU002_07/infection/cox_wen/05_07_2025_post1wave_4time_rmhistVaxInf/compiled_results/suppressed_compiled_HR_results_out_',i,'_date_covid_TO_RELEASE.csv'))
...
write_csv(life_table_ate, "life_table_ate_inf_period2_20250729.csv")
write_csv(life_table_carditis, "life_table_carditis_inf_period2_20250729.csv")
write_csv(life_table_inflammatory, "life_table_inflammatory_inf_period2_20250729.csv")
write_csv(life_table_vte, "life_table_vte_inf_period2_120250729.csv")
write_csv(life_table_thrombocytopenia, "life_table_thrombocytopenia_inf_period2_20250729.csv")
